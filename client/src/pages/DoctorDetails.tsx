...
export default function DoctorDetails() {
        ...
        if (!user) {
          ...
          try {
            ...
            setFormData({
              ...
              experience: details.experience ? details.experience.toString() : "",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description: "Failed to save doctor details. Please try again.",
        variant: "destructive",
      });
    } finally {
      setLoading(false);
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <Card className="w-full max-w-2xl">
        <CardHeader className="space-y-1">
          <CardTitle className="text-2xl font-bold text-center">Doctor Details</CardTitle>
