        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex justify-between">
                <span className="font-medium">Relation to Patient:</span>
                <span>{userDetails?.relationWithPatient || "Not provided"}</span>
              </div>
              <div className="flex justify-between">
                <span className="font-medium">Patient's Name:</span>
                <span>{userDetails?.patientName || "Not provided"}</span>
              </div>
              <div className="flex justify-between">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Latest information about your patient</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-8">
                <p className="text-muted-foreground">No recent updates</p>
                <Button className="mt-4">View Patient Status</Button>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="md:col-span-2">
            <CardHeader>
              <CardTitle>Contact Tracing Alerts</CardTitle>
              <CardDescription>Exposure notifications for your patient</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-8">
                <p className="text-muted-foreground">No exposure alerts at this time</p>
                <Button className="mt-4">View Alert History</Button>
              </div>
            </CardContent>
          </Card>
        </div>
