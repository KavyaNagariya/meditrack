        ...
        <div className="grid gap-12 md:grid-cols-4">
          <div className="md:col-span-1">
            <div className="flex items-center gap-2">
              <img src={logo} className="h-7 w-7" alt="CodeVeda Logo" data-testid="footer-logo-icon" />
            ...
            <p className="mt-4 text-sm text-muted-foreground" data-testid="footer-tagline">
              Advanced healthcare solutions for the modern world.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm text-muted-foreground">
              <li data-testid="footer-contact-email">support@codeveda.com</li>
              <li data-testid="footer-contact-phone">1-800-CODEVEDA</li>
        ...
        <div className="mt-12 border-t pt-8">
          <div className="flex flex-col items-center justify-between gap-4 text-sm text-muted-foreground md:flex-row">
            <p data-testid="footer-copyright">
              © 2025 CodeVeda. All rights reserved.
            </p>
